package fraudApplication.FraudConfig;
...
public class FraudConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Autowired Properties properties, @Autowired DataSource dataSource) {
        ...
        containerEntityManagerFactoryBean.setPackagesToScan(Frauder.class.getPackage().getName(), FrauderEmail.class.getPackage().getName());
